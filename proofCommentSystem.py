...
class ProofCommentSystem:
    ...
    def __init__(self) -> None:
        ...
        self.current_passphrase : str = self.gen_random_passphrase(self.passphrase_len)

    def gen_random_passphrase(self, length : int) -> str:
    ...
    def add_comment(self, comment : str) -> str:
        ...
        if self.current_proof:
            ...
            self.current_passphrase = self.gen_random_passphrase(self.passphrase_len)
